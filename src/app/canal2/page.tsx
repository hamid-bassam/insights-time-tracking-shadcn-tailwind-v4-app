...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen bg-black overflow-hidden text-white">
      {/* Navigation Bar */}
      <header className="absolute top-0 w-full px-6 py-4 flex items-center justify-between z-20 bg-black/60 backdrop-blur-md">
        <div className="text-xl font-bold tracking-wider">TimeFlow</div>
        ...
        <Button className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-400 hover:to-indigo-500 px-4 py-2 text-sm font-semibold">
          Get Started
        </Button>
      </header>
      ...
      <section id="features" className="relative z-10 max-w-5xl mx-auto px-4 py-16">
        <h2 className="text-4xl font-bold text-center mb-6">Why TimeFlow?</h2>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 py-16">
        <h2 className="text-4xl font-bold text-center mb-6">How We Stand Out</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <ul className="list-disc list-inside text-gray-400">
              ...
              <li>Limited or no real-time collaboration features.</li>
            </ul>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <ul className="list-disc list-inside text-gray-400">
              ...
              <li>Collaboration is baked in for entire teams.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 py-16 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <ul className="list-disc list-inside text-left text-gray-400 mt-4">
      ...
      <section className="relative z-10 mt-16 mb-24 text-center px-4">
        <h2 className="text-4xl font-bold">Take Control of Your Time Today</h2>
